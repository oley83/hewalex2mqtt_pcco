...
class PCCO(BaseDevice):
    ...
    registers = {
        ...
        399: { 'type': 'te10', 'name': 'delta', 'desc': 'Delta regulacji sprężarki' },
        400: { 'type': 'te10', 'name': 'biegCO', 'desc': 'Ustawiony bieg pompy skraplacza dla CO' },
        401: { 'type': 'te10', 'name': 'biegCWU', 'desc': 'Ustawiony bieg pompy skraplacza dla CWU' },
